...
/**
 * Класс для определения generic-класса
 *
 * @author Alex Tracer, Ivashin Alexey
 */
...
//        System.out.println("===============");
     ...
     * параметризован один из его предков (реализующих классов) с
     * generic-параметрами.
     *
     * @param actualClass анализируемый класс
     * @param genericClass класс (или интерфейс), для которого определяется
     * значение параметра
