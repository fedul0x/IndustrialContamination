...
public class ContaminationByFederalClassification extends DataEntity {
    ...
    public ContaminationByFederalClassification() {
    }

    public ContaminationByFederalClassification(Long id) {
        this.id = id;
    }

    public ContaminationByFederalClassification(Long code, String description, Byte dangerousCode) {
        this.code = code;
