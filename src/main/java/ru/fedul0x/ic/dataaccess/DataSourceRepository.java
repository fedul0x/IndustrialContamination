...
import ru.fedul0x.ic.dataaccess.dataobject.Company;
...
//        DataSourceHibernate<type> dsh = new DataSourceHibernate<type>();
        DataSourceHibernate<Company> dsh = new DataSourceHibernate<Company>(Company.class);
        return (DataSourceHibernate<Company>)dsh;
    }
